"""Stage 1 — replay each source question through the live Medora server.

Captures the structured card output that Medora would emit and bundles
it with the question and patient profile. The output is "what Medora
...
async def _replay_one(
    ...
    """Send one (possibly multi-turn) conversation to Medora and capture
