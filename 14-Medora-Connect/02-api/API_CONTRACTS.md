# Medora Connect — API Contracts

All Medora Connect APIs are added under new namespaces:
...
All routes are authenticated using the existing Medora auth/session strategy. Permission checks use the family permission model defined in `04-security/OAUTH_AND_PRIVACY.md`.
...
**Response (302)** — redirect back to Medora Connect status page.
