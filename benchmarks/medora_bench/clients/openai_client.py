...
the same patient_context block we feed Medora, so both systems see
identical input.

This is the "honest baseline" — strong enough that any Medora win
...
class OpenAIClient(ChatClient):
    ...
    async def send_turn(
        ...
        # Mirror the Medora injection pattern so both systems get the
