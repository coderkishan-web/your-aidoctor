...
- Hugging Face artifacts:
  ...
  - `medora/medora-classify-symptom-extractor` (v0)
  - `medora/medora-classify-risk-model` (v0)
  - `medora/medora-classify-demo`
...
**Goal:** deploy Medora Classify alongside clinicians as advisory output. Still no autonomous patient-facing role.
...
**Goal:** safely expose Medora Classify to parents/adult users via the Medora Family app, with conservative thresholds and aggressive red-flag escalation.

### Build

- Family-facing UI inside Medora Family.
