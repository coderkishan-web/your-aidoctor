  ...
  return (
    <div data-screen-label="Desktop · Settings">
      <PageHeader
        ...
        title="Settings"
        subtitle="Manage your Medora Family preferences, AI assistant, and connected services."
      />
        ...
        <div>
          ...
          {section === 'personalization' && (
            <Card title="Personalization · Memory & style">
              <SettingRow label="AI memory" desc="Let Medora remember your family's preferences across chats" control={<Toggle on={true} onChange={() => {}}/>}/>
          ...
          {section === 'privacy' && (
            <Card title="Privacy & data">
              ...
              <SettingRow label="Auto-sync to Medora Cloud" desc="Encrypted backup across your linked devices" control={<Toggle on={t('autoSync')} onChange={setT('autoSync')}/>}/>
              <SettingRow label="Anonymous usage analytics" desc="Help improve Medora — no health data is ever sent" control={<Toggle on={t('telemetry')} onChange={setT('telemetry')}/>}/>
          ...
          {section === 'ollama' && (
            <>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 220px', gap: 24, alignItems: 'flex-start' }}>
                  <div>
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 6 }}>
                      ...
                      }}>Run Medora AI on your own machine</span>
                    ...
                    <div style={{ fontSize: 13, color: TOKENS.ink2, lineHeight: 1.55, marginBottom: 14 }}>
                      OllaBridge Cloud (ollabridge.com) securely connects Medora Family to a local{' '}
              ...
              <Card title="AI assistant preferences">
                ...
                <SettingRow label="Cloud AI fallback"               desc="If bridge is offline, route to Medora Cloud (encrypted)" control={<Toggle on={t('aiCloud')} onChange={setT('aiCloud')}/>}/>
          ...
          {section === 'help' && (
            <Card title="Help & support">
              ...
              <SettingRow label="Send feedback"    desc="Help shape the next version of Medora Family" control={<button style={btnGhost}>Send</button>}/>
          ...
          {section === 'about' && (
            <Card title="About Medora Family">
              ...
              <div style={{
                ...
                Medora Family organizes your records. It does not diagnose, prescribe, or replace
          ...
          {section === 'logout' && (
            <Card title="Sign out">
              <div style={{ fontSize: 13, color: TOKENS.ink2, lineHeight: 1.55, marginBottom: 16 }}>
                You&apos;re about to sign out of Medora Family on this device. Your encrypted data
