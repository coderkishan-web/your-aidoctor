# Medora Family — Frontend

Production-ready Next.js + React + TypeScript implementation of the Medora Family dashboard, generated from a Claude Design handoff bundle.

## Run

```bash
cd 13-Medora-Family/frontend
npm install
npm run dev
```
...
Generated from the handoff bundle that included `Medora Family.html` plus shared JSX components (`desktop.jsx`, `mobile.jsx`, `screens.jsx`, `data.jsx`, `icons.jsx`).

## Disclaimer

> Medora Family organizes records — it does not diagnose, prescribe, or change dosage. Always confirm schedules with your pediatrician.
