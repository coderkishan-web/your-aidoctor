# Medora Family — Backend Architecture (MVP → v2)
...
This backend is designed to integrate with the existing Medora app stack in this repository and follows the contracts and safety boundaries already documented in:

- `13-Medora-Family/01-product/PRODUCT_SPEC.md`
- `13-Medora-Family/02-contracts/family_contracts.md`
- `13-Medora-Family/08-security/PRIVACY_AND_SAFETY.md`
...
4. Reuse auth/session strategy already used by current Medora routes
