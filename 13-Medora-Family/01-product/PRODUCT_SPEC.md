...
Create a family layer on top of Medora where each Medora client can link to a family admin. The family layer organizes members in a tree and shows monthly health timelines.
...
### Adult Member
Owns their own Medora profile. Can accept or decline family sharing and control which fields are visible.
...
Keep Medora simple for normal users. Show advanced family tools only in Family Admin mode.
