...
For the first implementation, family data is stored in scoped localStorage. This matches the existing Medora local-first behavior and avoids backend risk.
...
No destructive migration is needed. Existing personal Medora data remains untouched. Family data uses new storage keys.
