...
Usage:
    python infer.py --adapter adapters/deepseek-medora-v4
    python infer.py --adapter adapters/deepseek-medora-v4 --prompt "I have back pain"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Quick inference test against fine-tuned Medora")
