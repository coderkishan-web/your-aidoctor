...
they produce a long diagnostic ramble. Medora instead emits a
...
The Medora server already emits the right card for these phrasings —
...
def _build_refusal_case(idx: int, user_text: str, kind: str) -> dict:
    """Build one source-question row that, when traced through Medora,
