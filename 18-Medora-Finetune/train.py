#!/usr/bin/env python3
"""Unsloth SFT training for DeepSeek-Medora-v4.
...
def card_compliance_score(reply: str, expected_kind: str, expected_emergency: str | None) -> dict:
    """Three lightweight metrics matching benchmarks/medora_bench/evaluators."""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Unsloth SFT training for DeepSeek-Medora-v4")
