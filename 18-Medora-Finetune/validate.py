#!/usr/bin/env python3
"""Post-training validation — does DeepSeek-Medora-v4 beat the
...
the production Medora benchmark uses, so we can compare:
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Validate DeepSeek-Medora-v4 against benchmark cases")
    ...
    from medora_bench.runner import load_cases, _score_replies
    from medora_bench.types import Reply
