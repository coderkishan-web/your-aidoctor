...
export async function generateContent(systemPrompt = '', userMessage = '') {
    ...
    const candidateModels = ['gemini-flash-latest', 'gemini-3.6-flash', 'gemini-2.0-flash-lite', 'gemini-2.0-flash'];
    ...
    for (const model of candidateModels) {
        try {
            ...
            console.error(`[GeminiService] ${model} API error:`, e.message);
        }
    }
