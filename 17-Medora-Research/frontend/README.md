# Medora Research — Frontend

Production-ready Next.js + React + TypeScript implementation of the Medora Research command center, generated from a Claude Design handoff bundle.

## Run

```bash
cd 17-Medora-Research/frontend
npm install
npm run dev
```
...
> **Research workflows only** — not diagnosis, prescription, or patient-specific treatment advice. Medora Research is not a substitute for professional judgment.
