# Medora Research & Development

Medora Research & Development is the additive **research layer** of the Medora ecosystem. It is designed for biomedical literature review, hypothesis generation, candidate-medicine comparison, in-silico simulation **planning**, evidence grading, experiment tracking, and publication preparation.
...
The relevant persona links (used as the delivery channel for Medora Research personas):
...
| Disease area | Why it's interesting for Medora Research |
|---|---|
...
These disease areas seed the demo project library; they are **not** clinical use cases. No claim is made that Medora Research finds cures for them.
...
├── Medora Family            (13-Medora-Family)
├── Medora Connect           (14-Medora-Connect)
├── Medora Classify          (15-Medora-Classify)
├── Medora Pathogen          (16-Medora-Pathogen)
└── Medora Research          (this module)
...
Like every Medora module since 13, Medora Research is **additive**:

- No existing file, table, or API is modified.
- It can be removed in one operation without affecting the rest of Medora.
- It is feature-flagged at the API and persona-loader boundary.
- Patient PHI from Medora Family / Medora Connect **never** flows into research projects automatically.
...
| [`02-personas/RESEARCHER_AND_DOCTOR_ANALYSIS.md`](02-personas/RESEARCHER_AND_DOCTOR_ANALYSIS.md) | Analysis of HomePilot Researcher and General Doctor personas, mapping into Medora R&D. |
...
| [`10-integration-medora/INTEGRATION_PLAN.md`](10-integration-medora/INTEGRATION_PLAN.md) | How Medora Research plugs into the rest of the ecosystem. |
...
| [`12-sql/medora_research_schema.sql`](12-sql/medora_research_schema.sql) | Additive SQL schema for the research module. |

## Cross-references

- [`../13-Medora-Family/README.md`](../13-Medora-Family/README.md) — family permission and consent rules.
- [`../14-Medora-Connect/README.md`](../14-Medora-Connect/README.md) — vitals/devices; explicitly **not** a research data source unless governance + de-identification are in place.
- [`../15-Medora-Classify/README.md`](../15-Medora-Classify/README.md) — clinical reasoning module; relevant for downstream evaluation, never as a way to bypass research safety.
- [`../16-Medora-Pathogen/README.md`](../16-Medora-Pathogen/README.md) — pathogen ID; relevant for targeted research projects (e.g., antimicrobial discovery).
