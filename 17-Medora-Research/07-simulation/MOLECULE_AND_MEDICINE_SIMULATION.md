...
Medora Research & Development supports **in-silico** and **research-only** simulation **planning**. It does not run wet-lab experiments, does not interact with human subjects, and does not imply that a simulation proves efficacy or safety in humans.
