# Medora R&D — Agent Roles

Medora Research & Development is structured as six cooperating agents. Each ships as a persona in the HomePilotAI persona format (manifest + blueprint + agentic + MCP server contract).
