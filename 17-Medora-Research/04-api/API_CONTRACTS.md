# Medora Research & Development — API Contracts

All Medora Research APIs live under a new namespace:

```text
/api/research/*
```

Existing Medora routes are unchanged. Every route is authenticated, permission-checked, and audit-logged via `09-safety/RESEARCH_SAFETY_AND_GOVERNANCE.md`.
