# Medora Pathogen — Dataset Strategy
...
- They can be released as a curated, license-clean public seed dataset (`medora/medora-pathogen-public-seed`).
...
A real, multi-site, consented dataset is the path to a clinically credible Medora Pathogen.
...
medora/medora-pathogen-clinician-curated
...
- **No dataset is included in Medora Pathogen training without a positive license review.**
