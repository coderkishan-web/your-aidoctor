# Medora Pathogen — MCP Tool Contracts

Medora Pathogen ships as an MCP server with five tools:
...
```json
{
  "status": "success",
  "model_versions": {
    "microscopy": "medora-pathogen-microscopy@1.0.0",
...
```json
{
  "status": "success",
  "model_versions": {
    "xray": "medora-pathogen-chest-xray@0.7.2",
...
```json
{
  "status": "success",
  "model_versions": {
    "sequence": "medora-pathogen-sequence@0.5.1",
...
```json
{
  ...
  "evidence_pointers": [
    { "claim": "Lobar consolidation pattern association.", "guideline": "IDSA pneumonia guideline", "retrieved_via": "medora-pathogen-rag" }
  ]
}
```
